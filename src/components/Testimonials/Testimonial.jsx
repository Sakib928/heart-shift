const Testimonial = () => {
  return (
    <section className="my-8 dark:bg-gray-800 dark:text-white">
      ...
      <div className="container flex flex-col items-center justify-center mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly lg:px-10">
        <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
          <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 dark:bg-gray-800">
            <p className="relative px-6 py-1 text-lg italic text-center dark:text-white">
              <svg
              ...
              &quot;Exceptional service! Exceeded all expectations. Highly
              recommend for their unparalleled commitment to quality,
              reliability, and customer satisfaction. A+++ service!&quot;
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
                fill="currentColor"
